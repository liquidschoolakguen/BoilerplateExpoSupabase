...
CREATE POLICY "All authentificated users ALL operations" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "Allow authenticated users to select" ON "public"."products" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "Allow authentificated users ALL operations" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);
